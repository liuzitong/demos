...
#include "qmlmsgbusdemo/main/appctrl/qmlmsgbusdemo_appctrl.hxx"
...
{
    qInfo("%s, current new counter = %d", stage, qmlmsgbusdemo_curr_new_cntr );
...
int  main ( int argc, char *argv[] )
{
    ...
    gPrintMemCntr("pre-stage");
    {
        ...
        qmlMsgbusDemo::AppCtrl *app_ctrl = new qmlMsgbusDemo::AppCtrl;
        app_ctrl->doInit();
        ...
        eng->load(QUrl(QLatin1String("qrc:/qmlmsgbusdemo/main/view/main.qml")));
