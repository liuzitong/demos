...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  QMLMSGBUSDEMO_PIMPLPRIVTEMP_HXX
#define  QMLMSGBUSDEMO_PIMPLPRIVTEMP_HXX
...
#define QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define QMLMSGBUSDEMO_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef QMLMSGBUSDEMO_PImplPrivTemp_new
#define QMLMSGBUSDEMO_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef QMLMSGBUSDEMO_PImplPrivTemp_delete
#define QMLMSGBUSDEMO_PImplPrivTemp_delete( o, t )  do{ delete QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return QMLMSGBUSDEMO_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return QMLMSGBUSDEMO_PImplPrivTemp_new( T,  * QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define QMLMSGBUSDEMO_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( void**, s ), QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( void**, d ))

#define QMLMSGBUSDEMO_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            QMLMSGBUSDEMO_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return QMLMSGBUSDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
