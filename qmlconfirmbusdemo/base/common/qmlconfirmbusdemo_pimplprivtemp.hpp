...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  QMLCONFIRMBUSDEMO_PIMPLPRIVTEMP_HXX
#define  QMLCONFIRMBUSDEMO_PIMPLPRIVTEMP_HXX
...
#define QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define QMLCONFIRMBUSDEMO_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef QMLCONFIRMBUSDEMO_PImplPrivTemp_new
#define QMLCONFIRMBUSDEMO_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef QMLCONFIRMBUSDEMO_PImplPrivTemp_delete
#define QMLCONFIRMBUSDEMO_PImplPrivTemp_delete( o, t )  do{ delete QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return QMLCONFIRMBUSDEMO_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return QMLCONFIRMBUSDEMO_PImplPrivTemp_new( T,  * QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define QMLCONFIRMBUSDEMO_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( void**, s ), QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( void**, d ))

#define QMLCONFIRMBUSDEMO_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            QMLCONFIRMBUSDEMO_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return QMLCONFIRMBUSDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
