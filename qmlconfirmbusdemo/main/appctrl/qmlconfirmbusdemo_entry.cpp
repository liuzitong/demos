...
#include "qmlconfirmbusdemo/main/appctrl/qmlconfirmbusdemo_appctrl.hxx"
...
{
    qInfo("%s, current new counter = %d", stage, qmlconfirmbusdemo_curr_new_cntr );
...
int  main ( int argc, char *argv[] )
{
    ...
    gPrintMemCntr("pre-stage");
    {
        ...
        qmlconfirmbusdemo::AppCtrl *app_ctrl = new qmlconfirmbusdemo::AppCtrl;
        app_ctrl->doInit();
        ...
        eng->load(QUrl(QLatin1String("qrc:/qmlconfirmbusdemo/main/view/main.qml")));
