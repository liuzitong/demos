...
#include "qmlicquickimageitemdemo/main/appctrl/qmlicquickimageitemdemo_appctrl.hxx"
...
{
    qInfo("%s, current new counter = %d", stage, qmlicquickimageitemdemo_curr_new_cntr );
...
int  main ( int argc, char *argv[] )
{
    ...
    gPrintMemCntr("pre-stage");
    {
        ...
        qmlIcquickimageitemDemo::AppCtrl *app_ctrl = new qmlIcquickimageitemDemo::AppCtrl;
        app_ctrl->doInit();
        ...
        eng->load(QUrl(QLatin1String("qrc:/qmlicquickimageitemdemo/main/view/main.qml")));
