...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  QMLICQUICKIMAGEITEMDEMO_PIMPLPRIVTEMP_HXX
#define  QMLICQUICKIMAGEITEMDEMO_PIMPLPRIVTEMP_HXX
...
#define QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_new
#define QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_delete
#define QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_delete( o, t )  do{ delete QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_new( T,  * QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( void**, s ), QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( void**, d ))

#define QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return QMLICQUICKIMAGEITEMDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
