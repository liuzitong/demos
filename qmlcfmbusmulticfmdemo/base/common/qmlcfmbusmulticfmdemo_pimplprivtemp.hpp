...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  QMLCFMBUSMULTICFMDEMO_PIMPLPRIVTEMP_HXX
#define  QMLCFMBUSMULTICFMDEMO_PIMPLPRIVTEMP_HXX
...
#define QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_new
#define QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_delete
#define QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_delete( o, t )  do{ delete QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_new( T,  * QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( void**, s ), QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( void**, d ))

#define QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return QMLCFMBUSMULTICFMDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
