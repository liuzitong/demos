...
#include "qmlcfmbusmulticfmdemo/main/appctrl/qmlcfmbusmulticfmdemo_appctrl.hxx"
...
{
    qInfo("%s, current new counter = %d", stage, qmlcfmbusmulticfmdemo_curr_new_cntr );
...
int  main ( int argc, char *argv[] )
{
    ...
    gPrintMemCntr("pre-stage");
    {
        ...
        qmlCfmBusMulticfmDemo::AppCtrl *app_ctrl = new qmlCfmBusMulticfmDemo::AppCtrl;
        app_ctrl->doInit();
        ...
        eng->load(QUrl(QLatin1String("qrc:/qmlcfmbusmulticfmdemo/main/view/main.qml")));
