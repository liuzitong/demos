...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  QMLPAGELAYOUTDEMO_PIMPLPRIVTEMP_HXX
#define  QMLPAGELAYOUTDEMO_PIMPLPRIVTEMP_HXX
...
#define QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define QMLPAGELAYOUTDEMO_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef QMLPAGELAYOUTDEMO_PImplPrivTemp_new
#define QMLPAGELAYOUTDEMO_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef QMLPAGELAYOUTDEMO_PImplPrivTemp_delete
#define QMLPAGELAYOUTDEMO_PImplPrivTemp_delete( o, t )  do{ delete QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return QMLPAGELAYOUTDEMO_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return QMLPAGELAYOUTDEMO_PImplPrivTemp_new( T,  * QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define QMLPAGELAYOUTDEMO_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( void**, s ), QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( void**, d ))

#define QMLPAGELAYOUTDEMO_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            QMLPAGELAYOUTDEMO_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return QMLPAGELAYOUTDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
