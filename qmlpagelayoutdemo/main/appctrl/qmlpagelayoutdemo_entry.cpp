...
#include "qmlpagelayoutdemo/main/appctrl/qmlpagelayoutdemo_appctrl.hxx"
...
{
    qInfo("%s, current new counter = %d", stage, qmlpagelayoutdemo_curr_new_cntr );
...
int  main ( int argc, char *argv[] )
{
    ...
    gPrintMemCntr("pre-stage");
    {
        ...
        qmlPagelayoutDemo::AppCtrl *app_ctrl = new qmlPagelayoutDemo::AppCtrl;
        app_ctrl->doInit();
        ...
        eng->load(QUrl(QLatin1String("qrc:/qmlpagelayoutdemo/main/view/main.qml")));
