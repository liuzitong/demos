...
#include "qmluserlistmodeldemo/main/appctrl/qmluserlistmodeldemo_appctrl.hxx"
...
{
    qInfo("%s, current new counter = %d", stage, qmluserlistmodeldemo_curr_new_cntr );
...
int  main ( int argc, char *argv[] )
{
    ...
    gPrintMemCntr("pre-stage");
    {
        ...
        qmlUserListmodelDemo::AppCtrl *app_ctrl = new qmlUserListmodelDemo::AppCtrl;
        app_ctrl->doInit();
        ...
        eng->load(QUrl(QLatin1String("qrc:/qmluserlistmodeldemo/main/view/main.qml")));
