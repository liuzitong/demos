...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  QMLUSERLISTMODELDEMO_PIMPLPRIVTEMP_HXX
#define  QMLUSERLISTMODELDEMO_PIMPLPRIVTEMP_HXX
...
#define QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define QMLUSERLISTMODELDEMO_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef QMLUSERLISTMODELDEMO_PImplPrivTemp_new
#define QMLUSERLISTMODELDEMO_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef QMLUSERLISTMODELDEMO_PImplPrivTemp_delete
#define QMLUSERLISTMODELDEMO_PImplPrivTemp_delete( o, t )  do{ delete QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return QMLUSERLISTMODELDEMO_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return QMLUSERLISTMODELDEMO_PImplPrivTemp_new( T,  * QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define QMLUSERLISTMODELDEMO_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( void**, s ), QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( void**, d ))

#define QMLUSERLISTMODELDEMO_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            QMLUSERLISTMODELDEMO_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return QMLUSERLISTMODELDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
