...
#include "$D{Key2_ProjNameL}/main/appctrl/$D{Key2_ProjNameL}_appctrl.hxx"
...
{
    qInfo("%s, current new counter = %d", stage, $D{Key2_ProjNameL}_curr_new_cntr );
...
int  main ( int argc, char *argv[] )
{
    ...
    gPrintMemCntr("pre-stage");
    {
        ...
        $D{Key2_ProjNameN}::AppCtrl *app_ctrl = new $D{Key2_ProjNameN}::AppCtrl;
        app_ctrl->doInit();
        ...
        eng->load(QUrl(QLatin1String("qrc:/$D{Key2_ProjNameL}/main/view/main.qml")));
