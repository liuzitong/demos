...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  LIBANDQMLTESTDEMO_PIMPLPRIVTEMP_HXX
#define  LIBANDQMLTESTDEMO_PIMPLPRIVTEMP_HXX
...
#define LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define LIBANDQMLTESTDEMO_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef LIBANDQMLTESTDEMO_PImplPrivTemp_new
#define LIBANDQMLTESTDEMO_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef LIBANDQMLTESTDEMO_PImplPrivTemp_delete
#define LIBANDQMLTESTDEMO_PImplPrivTemp_delete( o, t )  do{ delete LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return LIBANDQMLTESTDEMO_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return LIBANDQMLTESTDEMO_PImplPrivTemp_new( T,  * LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define LIBANDQMLTESTDEMO_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( void**, s ), LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( void**, d ))

#define LIBANDQMLTESTDEMO_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            LIBANDQMLTESTDEMO_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return LIBANDQMLTESTDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
