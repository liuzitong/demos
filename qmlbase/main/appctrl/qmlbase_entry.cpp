...
#include "qmlbase/main/appctrl/qmlbase_appctrl.hxx"
...
{
    qInfo("%s, current new counter = %d", stage, qmlbase_curr_new_cntr );
...
int  main ( int argc, char *argv[] )
{
    ...
    gPrintMemCntr("pre-stage");
    {
        ...
        qmlbase::AppCtrl *app_ctrl = new qmlbase::AppCtrl;
        app_ctrl->doInit();
        ...
        eng->load(QUrl(QLatin1String("qrc:/qmlbase/main/view/main.qml")));
