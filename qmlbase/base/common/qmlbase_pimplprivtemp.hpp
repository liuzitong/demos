...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  QMLBASE_PIMPLPRIVTEMP_HXX
#define  QMLBASE_PIMPLPRIVTEMP_HXX
...
#define QMLBASE_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define QMLBASE_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef QMLBASE_PImplPrivTemp_new
#define QMLBASE_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef QMLBASE_PImplPrivTemp_delete
#define QMLBASE_PImplPrivTemp_delete( o, t )  do{ delete QMLBASE_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return QMLBASE_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return QMLBASE_PImplPrivTemp_new( T,  * QMLBASE_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            QMLBASE_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  QMLBASE_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define QMLBASE_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( QMLBASE_PImplPrivTemp_PtrCast( void**, s ), QMLBASE_PImplPrivTemp_PtrCast( void**, d ))

#define QMLBASE_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( QMLBASE_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return QMLBASE_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( QMLBASE_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            QMLBASE_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return QMLBASE_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( QMLBASE_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return QMLBASE_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
