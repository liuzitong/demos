#ifndef QMLMSGBUSMULTIWINDEMO_MS_MSGGENSVC_CXX
#define QMLMSGBUSMULTIWINDEMO_MS_MSGGENSVC_CXX

#include "qmlmsgbusmultiwindemo_ms_msggensvc.hxx"
#include <QTimer>
#include <QString>
#include <QDebug>
...
class QMLMSGBUSMULTIWINDEMO_HIDDEN  MsMsgGenSvcPriv : public QObject {
    Q_OBJECT
private:
    QTimer m_tmr;
    int    m_curr_idx;
...
{
    m_obj = qmlmsgbusmultiwindemo_new( MsMsgGenSvcPriv );
}
...
{
    qmlmsgbusmultiwindemo_delete( m_obj, MsMsgGenSvcPriv );
}


}
#include "qmlmsgbusmultiwindemo_ms_msggensvc.moc"
#endif
