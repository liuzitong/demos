#ifndef QMLMSGBUSMULTIWINDEMO_MM_MAINVM_CXX
#define QMLMSGBUSMULTIWINDEMO_MM_MAINVM_CXX
...
#include "qmlmsgbusmultiwindemo_mm_mainvm.hxx"
...
class QMLMSGBUSMULTIWINDEMO_HIDDEN  MmMainVmPriv : public QObject {
    Q_OBJECT
private:
...
{
    m_obj = qmlmsgbusmultiwindemo_new( MmMainVmPriv );
    QObject::connect (
...
{
    QObject::disconnect( );
    qmlmsgbusmultiwindemo_delete( m_obj, MmMainVmPriv );
}
...
#include "qmlmsgbusmultiwindemo_mm_mainvm.moc"
#endif
