...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  QMLMSGBUSMULTIWINDEMO_PIMPLPRIVTEMP_HXX
#define  QMLMSGBUSMULTIWINDEMO_PIMPLPRIVTEMP_HXX
...
#define QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_new
#define QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_delete
#define QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_delete( o, t )  do{ delete QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_new( T,  * QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( void**, s ), QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( void**, d ))

#define QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return QMLMSGBUSMULTIWINDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
