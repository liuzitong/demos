...
*/
/* ///////////////////////////////////////////////////////////////////// */
#ifndef  CONFIRMDEMO_PIMPLPRIVTEMP_HXX
#define  CONFIRMDEMO_PIMPLPRIVTEMP_HXX
...
#define CONFIRMDEMO_PImplPrivTemp_PtrCast( t, o ) (  reinterpret_cast< t >( reinterpret_cast< intptr_t >( o ))  )
#define CONFIRMDEMO_PImplPrivTemp_IntPtrCast( o ) (  reinterpret_cast< intptr_t >( o ))


#ifndef CONFIRMDEMO_PImplPrivTemp_new
#define CONFIRMDEMO_PImplPrivTemp_new( t, ... )  ( new t( __VA_ARGS__ ))
#endif

#ifndef CONFIRMDEMO_PImplPrivTemp_delete
#define CONFIRMDEMO_PImplPrivTemp_delete( o, t )  do{ delete CONFIRMDEMO_PImplPrivTemp_PtrCast( t*,  o ); }while(0)
#endif
...
public:   
    ...
    static T*    createInstance ( )           { return CONFIRMDEMO_PImplPrivTemp_new( T ); }
    static T*    createInstance ( void *ref ) { return CONFIRMDEMO_PImplPrivTemp_new( T,  * CONFIRMDEMO_PImplPrivTemp_PtrCast( T*, ref ) ); }
    static T*    addRef    ( void *cd )       {
        if ( cd != nullptr ) {
            CONFIRMDEMO_PImplPrivTemp_PtrCast( T*, cd )->addRefCntr( );
        }
        return  CONFIRMDEMO_PImplPrivTemp_PtrCast( T*, cd );
    }
...
#define CONFIRMDEMO_PImplPrivTemp_AttachPtr( t, s, d )\
    t :: attach( CONFIRMDEMO_PImplPrivTemp_PtrCast( void**, s ), CONFIRMDEMO_PImplPrivTemp_PtrCast( void**, d ))

#define CONFIRMDEMO_PImplPrivTemp_BuildIfNull( t, d ) \
    t :: buildIfNull( CONFIRMDEMO_PImplPrivTemp_PtrCast( void**, d ) )
...
T*   PImplPrivTemp<T> :: buildIfNull( void **w_obj )
{
    ...
    //return ( T *)( *w_obj );
    return CONFIRMDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
}
...
bool  PImplPrivTemp<T> :: releaseRef ( void *cd )
{
    ...
    if ( cd != nullptr ) {
        ...
        if ( CONFIRMDEMO_PImplPrivTemp_PtrCast( T*, cd )->releaseRefCntr() == 0 ) {
            CONFIRMDEMO_PImplPrivTemp_delete( cd, T );
            is_released = true;
        }
    }   	
    return is_released;
...
T *    PImplPrivTemp<T> :: duplicateIfShared( void **w_obj )
{
    ...
    if ( this->currRefCntr( ) == 1 ) { return CONFIRMDEMO_PImplPrivTemp_PtrCast( T *, *w_obj ); }
...
//    if ( (( T *) *w_obj)->currRefCntr( ) == 1 ) { return ( T *)( *w_obj ); }
    if ( CONFIRMDEMO_PImplPrivTemp_PtrCast( T*, *w_obj)->currRefCntr( ) == 1 ) {
        return CONFIRMDEMO_PImplPrivTemp_PtrCast( T*, *w_obj );
    }
