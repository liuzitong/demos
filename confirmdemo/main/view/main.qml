...
ApplicationWindow {
    ...
    QtObject {
        ...
        function init( )
        {
            ...
            main_vm = IcUiQmlApi.appCtrl.objMgr.attachObj( "confirmDemo::MmMainVm", false );
        ...
        function deinit( )
        {
            ...
            IcUiQmlApi.appCtrl.objMgr.detachObj( "confirmDemo::MmMainVm", main_vm );
        }
        ...
        function  onDemo0_reqConfirm( cfm_pkg )
        {
            ...
            var cmpt = Qt.createComponent("qrc:/confirmdemo/main/view/confirmdiag.qml");
