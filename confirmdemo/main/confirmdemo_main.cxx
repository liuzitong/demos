#ifndef CONFIRMDEMO_MAIN_CXX
#define CONFIRMDEMO_MAIN_CXX

#include "confirmdemo_main.hxx"

// services list
#include "confirmdemo/main/viewmodel/confirmdemo_mm_mainvm.hxx"
...
void  Main :: registerTypes( QxPack::IcAppCtrlBase *app_base )
{
    ...
    obj_mgr->registerType<confirmDemo::MmMainVm>(
        QStringLiteral("confirmDemo::MmMainVm"), Q_NULLPTR
    );
}
