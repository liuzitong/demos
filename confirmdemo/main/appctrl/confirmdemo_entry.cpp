...
#include "confirmdemo/main/appctrl/confirmdemo_appctrl.hxx"
...
{
    qInfo("%s, current new counter = %d", stage, confirmdemo_curr_new_cntr );
...
int  main ( int argc, char *argv[] )
{
    ...
    gPrintMemCntr("pre-stage");
    {
        ...
        confirmDemo::AppCtrl *app_ctrl = new confirmDemo::AppCtrl;
        app_ctrl->doInit();
        ...
        eng->load(QUrl(QLatin1String("qrc:/confirmdemo/main/view/main.qml")));
