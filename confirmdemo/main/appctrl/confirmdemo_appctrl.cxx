#ifndef CONFIRMDEMO_APPCTRL_CXX
#define CONFIRMDEMO_APPCTRL_CXX

#include "confirmdemo_appctrl.hxx"
#include "confirmdemo/base/service/confirmdemo_appsettingssvc.hxx"
#include "confirmdemo/base/service/confirmdemo_msgbussvc.hxx"
#include "confirmdemo/base/service/confirmdemo_objmgrsvc.hxx"
...
// modules manager
#include "confirmdemo/main/confirmdemo_main.hxx"
...
//    private objects
// ////////////////////////////////////////////////////////////////////////////
#define T_PrivPtr( o )  confirmdemo_objcast( AppCtrlPriv*, o )
class CONFIRMDEMO_HIDDEN AppCtrlPriv {
private:
    AppCtrl   *m_parent;
...
{
    m_obj = confirmdemo_new( AppCtrlPriv, this );
}
...
AppCtrl :: ~AppCtrl ( )
{
    confirmdemo_delete( m_obj, AppCtrlPriv );
}
